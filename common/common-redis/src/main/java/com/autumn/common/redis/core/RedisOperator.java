package com.autumn.common.redis.core;
...
public class RedisOperator<V> {
    ...
    public Boolean setIfAbsent(String key, V number, int timeout, TimeUnit timeUnit) {
        return redisTemplate.opsForValue().setIfAbsent(key, number, timeout, timeUnit);
    }
}
